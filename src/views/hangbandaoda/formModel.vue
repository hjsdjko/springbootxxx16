		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="到达时间" prop="daodashijian">
							<el-date-picker
								class="list_date"
								...
								type="datetime"
								:readonly="!isAdd||disabledForm.daodashijian?true:false"
								placeholder="请选择到达时间" />
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.daodashijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='daodashijian'){
					form.value.daodashijian = row[x];
					disabledForm.value.daodashijian = true;
					continue;
				}
			}
			if(row){
